...
# after fix camera and render

# load the trajectory of arm,hand 


# fix the object pose


# deform and render for the entire scene
...
from engine.mdh.mdh import calculate_franka_mdh_pre_frame,inverse_affine_transformation_torch
